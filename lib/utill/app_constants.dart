...
class AppConstants {
  static const String appName = 'مون';
  static const String slogan = 'تطبيق تسويق بالجملة';
  static const String appVersion = '14.3.1';
  static const String baseUrl = 'https://6valley.6amtech.com';//https://6valley.6amtech.com //https://commerce.zahraacademy.com
